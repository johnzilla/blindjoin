...
- ✅ **v1.6 Supply-Chain Attestation** — Phases 22-25 (shipped 2026-06-03)
...
<details>
<summary>✅ v1.6 Supply-Chain Attestation (Phases 22-25) — SHIPPED 2026-06-03</summary>

- [x] Phase 22: Base-Image Digest Drift Detection (6/6 plans) — completed 2026-06-01
- [x] Phase 23: cosign Image Attestations + SLSA + SBOM (5/5 plans) — completed 2026-06-02
- [x] Phase 24: Release Tarball Signing (4/4 plans; SIGN-03 PGP path deferred) — completed 2026-06-02
- [x] Phase 25: Reproducible-Build Recipe + Verifier (5/5 plans; REPRO-04 registry submission descoped at close) — completed 2026-06-03

Stripped 1,423 lines of process theater at milestone close (commits `bf102ab` + `54e5ea5`). v1.6.0 release tag pending the reproducibility baseline-capture procedure in `docs/RELEASING.md`.
