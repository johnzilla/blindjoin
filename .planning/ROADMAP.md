...
- [ ] 09-01-PLAN.md — Provision pinned bitcoind v30.2 in CI (BLINDJOIN_REQUIRE_BITCOIND env, .bitcoind-version pin, actions/cache + PGP-verified install, BITCOIND_EXE export)
...
| 9. CI integration-test reliability | v1.3 | 0/5 | Planned | — |
